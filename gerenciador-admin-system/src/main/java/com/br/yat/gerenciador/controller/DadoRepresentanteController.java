...
public class DadoRepresentanteController {
	...
	private void registrarAcoes() {
		view.getFtxtCpf().addFocusListener(ValidationUtils.createValidationListener(view.getFtxtCpf(), this::validarCpf));
		view.getFtxtTelefone().addFocusListener(ValidationUtils.createValidationListener(view.getFtxtTelefone(), this::validarTelefone));
