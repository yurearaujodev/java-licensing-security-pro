...
public class EnderecoDao extends GenericDao<Endereco> {
	...
	public Endereco save(Endereco end) {
		String sql = "INSERT INTO endereco(cep,logradouro,complemento,bairro,numero,cidade,estado,pais,criado_em,atualizado_em) "
				+ "VALUES(?,?,?,?,?,?,?,?, NOW(),NOW())";
	...
	public Endereco update(Endereco end){
		String sql = "UPDATE endereco SET cep=?, logradouro=?, complemento=?, bairro=?, numero=?, cidade=?, estado=?, pais=?,atualizado_em=NOW() "
				+ "WHERE id_endereco=?";
