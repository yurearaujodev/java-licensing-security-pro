...
public class DadoBancarioPanel extends JPanel {
	...
	public DadoBancarioPanel() {
		...
		montarTela();
		new DadoBancarioController(this);
	}
	...
	private void montarCampos(JPanel panel) {
		...
		ftxtCod = FieldFactory.createFormattedField();
		FormatterUtils.applyBank(ftxtCod, MaskFactory.createMask().get("BANCO"));
		panel.add(ftxtCod,"cell 1 0,growx, h 25!");
