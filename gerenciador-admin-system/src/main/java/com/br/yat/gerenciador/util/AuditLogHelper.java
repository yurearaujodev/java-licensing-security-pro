...
public class AuditLogHelper {
	...
	public static LogSistema gerarLogSucesso(String tipo, String acao, String entidade, Integer id, Object anterior,
			Object novo) {
		...
		if (anterior != null)
			log.setDadosAnteriores(objetoParaJson(anterior));
		if (novo != null)
			log.setDadosNovos(objetoParaJson(novo));
